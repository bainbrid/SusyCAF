...
{ 
produces <int>(prefix+"HLT_EvtType7"+suffix);
produces <int>(prefix+"HLT_EvtType6"+suffix);
produces <int>(prefix+"HLT_EvtType5"+suffix);
produces <int>(prefix+"HLT_EvtType4"+suffix);
produces <int>(prefix+"HLT_EvType0"+suffix);
produces <int>(prefix+"HLT_L1Jet6U"+suffix);
produces <int>(prefix+"HLT_Jet15U"+suffix);
produces <int>(prefix+"HLT_Jet30U"+suffix);
produces <int>(prefix+"HLT_Jet50U"+suffix);
produces <int>(prefix+"HLT_FwdJet20U"+suffix);
produces <int>(prefix+"HLT_DiJetAve15U_8E29"+suffix);
produces <int>(prefix+"HLT_DiJetAve30U_8E29"+suffix);
produces <int>(prefix+"HLT_QuadJet15U"+suffix);
produces <int>(prefix+"HLT_L1MET20"+suffix);
produces <int>(prefix+"HLT_MET45"+suffix);
produces <int>(prefix+"HLT_MET100"+suffix);
produces <int>(prefix+"HLT_HT100U"+suffix);
produces <int>(prefix+"HLT_L1MuOpen"+suffix);
produces <int>(prefix+"HLT_L1MuOpenPrescaled"+suffix);
produces <int>(prefix+"HLT_L1Mu"+suffix);
produces <int>(prefix+"HLT_L1Mu20"+suffix);
produces <int>(prefix+"HLT_L2Mu9"+suffix);
produces <int>(prefix+"HLT_L2Mu11"+suffix);
produces <int>(prefix+"HLT_IsoMu3"+suffix);
produces <int>(prefix+"HLT_Mu3"+suffix);
produces <int>(prefix+"HLT_Mu5"+suffix);
produces <int>(prefix+"HLT_Mu9"+suffix);
produces <int>(prefix+"HLT_L1DoubleMuOpen"+suffix);
produces <int>(prefix+"HLT_DoubleMu0"+suffix);
produces <int>(prefix+"HLT_DoubleMu3"+suffix);
produces <int>(prefix+"HLT_L1SingleEG5"+suffix);
produces <int>(prefix+"HLT_L1SingleEG8"+suffix);
produces <int>(prefix+"HLT_Ele10_LW_L1R"+suffix);
produces <int>(prefix+"HLT_Ele10_LW_EleId_L1R"+suffix);
produces <int>(prefix+"HLT_Ele15_LW_L1R"+suffix);
produces <int>(prefix+"HLT_Ele15_SC10_LW_L1R"+suffix);
produces <int>(prefix+"HLT_Ele15_SiStrip_L1R"+suffix);
produces <int>(prefix+"HLT_Ele20_LW_L1R"+suffix);
produces <int>(prefix+"HLT_L1DoubleEG5"+suffix);
produces <int>(prefix+"HLT_DoubleEle5_SW_L1R"+suffix);
produces <int>(prefix+"HLT_DoublePhoton5_eeRes_L1R"+suffix);
produces <int>(prefix+"HLT_DoublePhoton5_Jpsi_L1R"+suffix);
produces <int>(prefix+"HLT_DoublePhoton5_Upsilon_L1R"+suffix);
produces <int>(prefix+"HLT_Photon10_L1R"+suffix);
produces <int>(prefix+"HLT_Photon15_L1R"+suffix);
produces <int>(prefix+"HLT_Photon15_TrackIso_L1R"+suffix);
produces <int>(prefix+"HLT_Photon15_LooseEcalIso_L1R"+suffix);
produces <int>(prefix+"HLT_Photon20_L1R"+suffix);
produces <int>(prefix+"HLT_Photon30_L1R_8E29"+suffix);
produces <int>(prefix+"HLT_DoublePhoton10_L1R"+suffix);
produces <int>(prefix+"HLT_SingleLooseIsoTau20"+suffix);
produces <int>(prefix+"HLT_DoubleLooseIsoTau15"+suffix);
produces <int>(prefix+"HLT_BTagIP_Jet50U"+suffix);
produces <int>(prefix+"HLT_BTagMu_Jet10U"+suffix);
produces <int>(prefix+"HLT_StoppedHSCP_8E29"+suffix);
produces <int>(prefix+"HLT_L1Mu14_L1SingleEG10"+suffix);
produces <int>(prefix+"HLT_L1Mu14_L1SingleJet6U"+suffix);
produces <int>(prefix+"HLT_L1Mu14_L1ETM30"+suffix);
produces <int>(prefix+"HLT_ZeroBias"+suffix);
produces <int>(prefix+"HLT_ZeroBiasPrescaled"+suffix);
produces <int>(prefix+"HLT_MinBias"+suffix);
produces <int>(prefix+"HLT_MinBiasHcal"+suffix);
produces <int>(prefix+"HLT_MinBiasEcal"+suffix);
produces <int>(prefix+"HLT_MinBiasPixel"+suffix);
produces <int>(prefix+"HLT_MinBiasPixel_Trk5"+suffix);
produces <int>(prefix+"HLT_CSCBeamHalo"+suffix);
produces <int>(prefix+"HLT_CSCBeamHaloOverlapRing1"+suffix);
produces <int>(prefix+"HLT_CSCBeamHaloOverlapRing2"+suffix);
produces <int>(prefix+"HLT_CSCBeamHaloRing2or3"+suffix);
produces <int>(prefix+"HLT_BackwardBSC"+suffix);
produces <int>(prefix+"HLT_ForwardBSC"+suffix);
produces <int>(prefix+"HLT_TrackerCosmics"+suffix);
produces <int>(prefix+"HLT_IsoTrack_8E29"+suffix);
produces <int>(prefix+"HLT_Calibration"+suffix);
produces <int>(prefix+"HLT_EcalCalibration"+suffix);
produces <int>(prefix+"HLT_HcalCalibration"+suffix);
produces <int>(prefix+"HLT_Random"+suffix);
produces <int>(prefix+"HLT_Physics"+suffix);
produces <int>(prefix+"HLT_PhysicsNoMuon"+suffix);
produces <int>(prefix+"HLT_PhysicsNoMuonPrescaled"+suffix);
produces <int>(prefix+"HLT_PixelFEDSize"+suffix);
produces <int>(prefix+"HLT_HFThreshold"+suffix);
produces <int>(prefix+"HLT_GlobalRunHPDNoise"+suffix);
produces <int>(prefix+"HLT_TechTrigHCALNoise"+suffix);
produces <int>(prefix+"HLT_L1_BPTX"+suffix);
produces <int>(prefix+"HLT_L1_BSC"+suffix);
produces <int>(prefix+"HLT_L1_HFtech"+suffix);
produces <int>(prefix+"HLT_L2Mu3_NoVertex"+suffix);
produces <int>(prefix+"HLT_OIstateTkMu3"+suffix);
produces <int>(prefix+"HLT_EgammaSuperClusterOnly_L1R"+suffix);
produces <int>(prefix+"HLT_TrackPointing"+suffix);
...
std::auto_ptr< int> hlt_TrackPointing					  (new  int());
   ...
   *hlt_TrackPointing.get() 	         =  -1;			
    ...
    for(unsigned int i=0; i< hltresults->size(); i++) {
 	...
 	iEvent.put(hlt_EvtType7                    ,prefix+"HLT_EvtType7"+suffix);
	iEvent.put(hlt_EvtType6 		   ,prefix+"HLT_EvtType6"+suffix);
	iEvent.put(hlt_EvtType5 		   ,prefix+"HLT_EvtType5"+suffix);
	iEvent.put(hlt_EvtType4 		   ,prefix+"HLT_EvtType4"+suffix);
	iEvent.put(hlt_EvType0			   ,prefix+"HLT_EvType0"+suffix);
	iEvent.put(hlt_L1Jet6U			   ,prefix+"HLT_L1Jet6U"+suffix);
	iEvent.put(hlt_Jet15U			   ,prefix+"HLT_Jet15U"+suffix);
	iEvent.put(hlt_Jet30U			   ,prefix+"HLT_Jet30U"+suffix);
	iEvent.put(hlt_Jet50U			   ,prefix+"HLT_Jet50U"+suffix);
	iEvent.put(hlt_FwdJet20U		   ,prefix+"HLT_FwdJet20U"+suffix);
	iEvent.put(hlt_DiJetAve15U_8E29 	   ,prefix+"HLT_DiJetAve15U_8E29"+suffix);
	iEvent.put(hlt_DiJetAve30U_8E29 	   ,prefix+"HLT_DiJetAve30U_8E29"+suffix);
	iEvent.put(hlt_QuadJet15U		   ,prefix+"HLT_QuadJet15U"+suffix);
	iEvent.put(hlt_L1MET20			   ,prefix+"HLT_L1MET20"+suffix);
	iEvent.put(hlt_MET45			   ,prefix+"HLT_MET45"+suffix);
	iEvent.put(hlt_HT100U			   ,prefix+"HLT_HT100U"+suffix);
	iEvent.put(hlt_L1MuOpen 		   ,prefix+"HLT_L1MuOpen"+suffix);
	iEvent.put(hlt_L1MuOpenPrescaled	   ,prefix+"HLT_L1MuOpenPrescaled"+suffix);
	iEvent.put(hlt_L1Mu			   ,prefix+"HLT_L1Mu"+suffix);
	iEvent.put(hlt_L1Mu20			   ,prefix+"HLT_L1Mu20"+suffix);
	iEvent.put(hlt_L2Mu9			   ,prefix+"HLT_L2Mu9"+suffix);
	iEvent.put(hlt_L2Mu11			   ,prefix+"HLT_L2Mu11"+suffix);
	iEvent.put(hlt_IsoMu3			   ,prefix+"HLT_IsoMu3"+suffix);
	iEvent.put(hlt_Mu3			   ,prefix+"HLT_Mu3"+suffix);
	iEvent.put(hlt_Mu5			   ,prefix+"HLT_Mu5"+suffix);
	iEvent.put(hlt_Mu9			   ,prefix+"HLT_Mu9"+suffix);
	iEvent.put(hlt_L1DoubleMuOpen		   ,prefix+"HLT_L1DoubleMuOpen"+suffix);
	iEvent.put(hlt_DoubleMu0		   ,prefix+"HLT_DoubleMu0"+suffix);
	iEvent.put(hlt_DoubleMu3		   ,prefix+"HLT_DoubleMu3"+suffix);
	iEvent.put(hlt_L1SingleEG5		   ,prefix+"HLT_L1SingleEG5"+suffix);
	iEvent.put(hlt_L1SingleEG8		   ,prefix+"HLT_L1SingleEG8"+suffix);
	iEvent.put(hlt_Ele10_LW_L1R		   ,prefix+"HLT_Ele10_LW_L1R"+suffix);
 	iEvent.put(hlt_Ele10_LW_EleId_L1R	   ,prefix+"HLT_Ele10_LW_EleId_L1R"+suffix);
	iEvent.put(hlt_Ele15_LW_L1R		   ,prefix+"HLT_Ele15_LW_L1R"+suffix);
	iEvent.put(hlt_Ele15_SC10_LW_L1R	   ,prefix+"HLT_Ele15_SC10_LW_L1R"+suffix);
	iEvent.put(hlt_Ele15_SiStrip_L1R	   ,prefix+"HLT_Ele15_SiStrip_L1R"+suffix);
	iEvent.put(hlt_Ele20_LW_L1R		   ,prefix+"HLT_Ele20_LW_L1R"+suffix);
	iEvent.put(hlt_L1DoubleEG5		   ,prefix+"HLT_L1DoubleEG5"+suffix);
	iEvent.put(hlt_DoubleEle5_SW_L1R	   ,prefix+"HLT_DoubleEle5_SW_L1R"+suffix);
	iEvent.put(hlt_DoublePhoton5_eeRes_L1R	   ,prefix+"HLT_DoublePhoton5_eeRes_L1R"+suffix);
	iEvent.put(hlt_DoublePhoton5_Jpsi_L1R	   ,prefix+"HLT_DoublePhoton5_Jpsi_L1R"+suffix);
	iEvent.put(hlt_DoublePhoton5_Upsilon_L1R   ,prefix+"HLT_DoublePhoton5_Upsilon_L1R"+suffix);
	iEvent.put(hlt_Photon10_L1R		   ,prefix+"HLT_Photon10_L1R"+suffix);
	iEvent.put(hlt_Photon15_L1R		   ,prefix+"HLT_Photon15_L1R"+suffix);
	iEvent.put(hlt_Photon15_TrackIso_L1R	   ,prefix+"HLT_Photon15_TrackIso_L1R"+suffix);
	iEvent.put(hlt_Photon15_LooseEcalIso_L1R   ,prefix+"HLT_Photon15_LooseEcalIso_L1R"+suffix);
	iEvent.put(hlt_Photon20_L1R		   ,prefix+"HLT_Photon20_L1R"+suffix);
	iEvent.put(hlt_Photon30_L1R_8E29	   ,prefix+"HLT_Photon30_L1R_8E29"+suffix);
	iEvent.put(hlt_DoublePhoton10_L1R	   ,prefix+"HLT_DoublePhoton10_L1R"+suffix);
	iEvent.put(hlt_SingleLooseIsoTau20	   ,prefix+"HLT_SingleLooseIsoTau20"+suffix);
	iEvent.put(hlt_DoubleLooseIsoTau15	   ,prefix+"HLT_DoubleLooseIsoTau15"+suffix);
	iEvent.put(hlt_BTagIP_Jet50U		   ,prefix+"HLT_BTagIP_Jet50U"+suffix);
	iEvent.put(hlt_BTagMu_Jet10U		   ,prefix+"HLT_BTagMu_Jet10U"+suffix);
	iEvent.put(hlt_StoppedHSCP_8E29 	   ,prefix+"HLT_StoppedHSCP_8E29"+suffix);
	iEvent.put(hlt_L1Mu14_L1SingleEG10	   ,prefix+"HLT_L1Mu14_L1SingleEG10"+suffix);
	iEvent.put(hlt_L1Mu14_L1SingleJet6U	   ,prefix+"HLT_L1Mu14_L1SingleJet6U"+suffix);
	iEvent.put(hlt_L1Mu14_L1ETM30		   ,prefix+"HLT_L1Mu14_L1ETM30"+suffix);
	iEvent.put(hlt_ZeroBias 		   ,prefix+"HLT_ZeroBias"+suffix);
	iEvent.put(hlt_ZeroBiasPrescaled	   ,prefix+"HLT_ZeroBiasPrescaled"+suffix);
	iEvent.put(hlt_MinBias			   ,prefix+"HLT_MinBias"+suffix);
	iEvent.put(hlt_MinBiasHcal		   ,prefix+"HLT_MinBiasHcal"+suffix);
	iEvent.put(hlt_MinBiasEcal		   ,prefix+"HLT_MinBiasEcal"+suffix);
	iEvent.put(hlt_MinBiasPixel		   ,prefix+"HLT_MinBiasPixel"+suffix);
	iEvent.put(hlt_MinBiasPixel_Trk5	   ,prefix+"HLT_MinBiasPixel_Trk5"+suffix);
 	iEvent.put(hlt_CSCBeamHalo		   ,prefix+"HLT_CSCBeamHalo"+suffix);
	iEvent.put(hlt_CSCBeamHaloOverlapRing1	   ,prefix+"HLT_CSCBeamHaloOverlapRing1"+suffix);
	iEvent.put(hlt_CSCBeamHaloOverlapRing2	   ,prefix+"HLT_CSCBeamHaloOverlapRing2"+suffix);
	iEvent.put(hlt_CSCBeamHaloRing2or3	   ,prefix+"HLT_CSCBeamHaloRing2or3"+suffix);
	iEvent.put(hlt_BackwardBSC		   ,prefix+"HLT_BackwardBSC"+suffix);
	iEvent.put(hlt_ForwardBSC		   ,prefix+"HLT_ForwardBSC"+suffix);
	iEvent.put(hlt_TrackerCosmics		   ,prefix+"HLT_TrackerCosmics"+suffix);
	iEvent.put(hlt_IsoTrack_8E29		   ,prefix+"HLT_IsoTrack_8E29"+suffix);
	iEvent.put(hlt_Calibration		   ,prefix+"HLT_Calibration"+suffix);
	iEvent.put(hlt_EcalCalibration		   ,prefix+"HLT_EcalCalibration"+suffix);
	iEvent.put(hlt_HcalCalibration		   ,prefix+"HLT_HcalCalibration"+suffix);
	iEvent.put(hlt_Random			   ,prefix+"HLT_Random"+suffix);
	iEvent.put(hlt_Physics			   ,prefix+"HLT_Physics"+suffix);
	iEvent.put(hlt_PhysicsNoMuon		   ,prefix+"HLT_PhysicsNoMuon"+suffix);
	iEvent.put(hlt_PhysicsNoMuonPrescaled	   ,prefix+"HLT_PhysicsNoMuonPrescaled"+suffix);
	iEvent.put(hlt_PixelFEDSize		   ,prefix+"HLT_PixelFEDSize"+suffix);
	iEvent.put(hlt_HFThreshold		   ,prefix+"HLT_HFThreshold"+suffix);
	iEvent.put(hlt_GlobalRunHPDNoise	   ,prefix+"HLT_GlobalRunHPDNoise"+suffix);
	iEvent.put(hlt_TechTrigHCALNoise	   ,prefix+"HLT_TechTrigHCALNoise"+suffix);
	iEvent.put(hlt_L1_BPTX			   ,prefix+"HLT_L1_BPTX"+suffix);
	iEvent.put(hlt_L1_BSC			   ,prefix+"HLT_L1_BSC"+suffix);
	iEvent.put(hlt_L1_HFtech		   ,prefix+"HLT_L1_HFtech"+suffix);
	iEvent.put(hlt_L2Mu3_NoVertex		   ,prefix+"HLT_L2Mu3_NoVertex"+suffix);
	iEvent.put(hlt_OIstateTkMu3		   ,prefix+"HLT_OIstateTkMu3"+suffix);
	iEvent.put(hlt_EgammaSuperClusterOnly_L1R  ,prefix+"HLT_EgammaSuperClusterOnly_L1R"+suffix);
	iEvent.put(hlt_TrackPointing		   ,prefix+"HLT_TrackPointing"+suffix);
