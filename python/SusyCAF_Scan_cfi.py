...
scanFormats = {'T1_xCHI' : r"# model T1_(\\d*\.\\d*)_(\\d*\.\\d*)_(\\d*\.\\d*)\\s",
               'T1' : r"# model T1_(\\d*\.\\d*)_(\\d*\.\\d*)\\s",
               'T2' : r"# model T2_(\\d*\.\\d*)_(\\d*\.\\d*)\\s",
               'T1tttt_xCHI' : r"# model T1tttt_(\\d*\.\\d*)_(\\d*\.\\d*)_(\\d*\.\\d*)\\s",
               'T1tttt' : r"# model T1tttt_(\\d*)_(\\d*)\\s*(\\d*.\\d*E-\\d*).*",
               'T1tttt_Madgraph' : r"# model T1tttt_(\\d*)_(\\d*)\\s*(\\d*.\\d*)\\s*",
               'T5tttt_Madgraph' : r"# model T5tttt_(\\d*)_(\\d*)_(\\d*).*",
	       ...
	       'T1bbbb_Madgraph' : r"# model T1bbbb_(\\d*)_(\\d*)\\s*(\\d*.\\d*)\\s*",
               'T1qqqq' : r"# model T1qqqq_(\\d*)_(\\d*)\\s*(\\d*.\\d*)\\s*",
	       'T1bb' : r"# model T1bb_(\\d*\.\\d*)_(\\d*\.\\d*)\\s",
               'T1tt' : r"# model T1tt_(\\d*\.\\d*)_(\\d*\.\\d*)\\s",
	       'T1ttcc' : r"# model T1ttcc_(\\d*)_(\\d*)\\s*(\\d*.\\d*)\\s*",
	       'T2bw_Madgraph' : r"# model T2bw_(\\d*)_(\\d*)_(\\d*)\\s*(\\d*.\\d*)\\s*",
	       ...
	       'T2bb_Madgraph' : r"# model T2bb_(\\d*)_(\\d*)\\s*(\\d*.\\d*)\\s*",
	       'T2qq' : r"# model T2qq_(\\d*)_(\\d*)\\s*(\\d*.\\d*)\\s*",
	       'T2cc' : r"# model T2cc_(\\d*)_(\\d*)\\s*(\\d*.\\d*)\\s*",
               'T2cc_Pythia' : r"# model T2cc_(\\d*\.\\d*)_(\\d*\.\\d*)\\s",
	             'T2tb' : r"# model T2tb_(\\d*)_(\\d*)\\s*(\\d*.\\d*)\\s*",
         'T2tt' : r"# model T2tt_(\\d*\.\\d*)_(\\d*\.\\d*)\\s",
	       'T2tt_Madgraph' : r"# model T2tt_(\\d*)_(\\d*)\\s*(\\d*.\\d*)\\s*",
                'T2_4body' : r"# model 8TeV_T2tt_2j_\\d*_\\d*_run\\d*_merged_(\\d*)_(\\d*)\\s*",
               'T2ttww' : r"# model T2ttww_(\\d*\.\\d*)_(\\d*\)_(\\d*\)\\s",
               'T3w' : r"# model T3w_(\\d*\.\\d*)_(\\d*\.\\d*)_(\\d*\.\\d*)\\s",
               'T3wb' : r"# model T3wb_(\\d*\.\\d*)_(\\d*\.\\d*)_(\\d*\.\\d*)\\s",
	       'T6bbHH' : r"# model T6bbHH_(\\d*)_(\\d*)_(\\d*.\\d*)\\s*(\\d*.\\d*)\\s*",
...
scanParameters = {"T1_xCHI" : ['xCHI', 'mGL', 'mLSP'],
                  "T1" : ['mGL', 'mLSP'],
                  "T2" : [ 'mGL', 'mLSP'],
                  "T1bbbb_xCHI" : ['xCHI', 'mGL', 'mLSP'],
                  "T1bbbb" : ['mGL', 'mLSP'],
	          "T1bbbb_Madgraph" : ['mGL', 'mLSP', 'xSEC'],
                  "T1qqqq" : ['mGL', 'mLSP', 'xSEC'],
		  "T1tttt_xCHI" : ['xCHI', 'mGL', 'mLSP'],
                  "T1tttt_Madgraph" : ['mGL', 'mLSP', 'xSEC'],
                  "T1tt1_Madgraph" : ['mSTOP', 'mLSP', 'xSEC'],
                  "T5tttt_Madgraph" : ['mGL', 'mSTOP', 'mLSP'],
		  ...
		  "T1bb" : ['mGL', 'mLSP'],
                  "T1tt" : ['mGL', 'mLSP'],
	          "T1ttcc" : ['mGL', 'mLSP'],
                  "T2bw_Madgraph" : ['mSTOP', 'mLSP', 'mCHI', 'xSEC'],
	          "T2bw" : ['xCHI', 'mGL', 'mLSP'],
		  "T2bb" : ['mGL', 'mLSP'],
	          "T2bb_Madgraph" : ['mSTOP', 'mLSP', 'xSEC'],
		  "T2qq" : ['mGL', 'mLSP', 'xSEC'],
	          "T2cc_Pythia" : ['mGL', 'mLSP'],
                  "T2cc" : ['mGL', 'mLSP', 'xSEC'],
 	          "T2tb" : ['mSTOP', 'mLSP', 'xSEC'],
            "T2tt" : ['mGL', 'mLSP'],
            "T2_4body" : ['mSTOP', 'mLSP'],
		  "T2tt_Madgraph" : ['mSTOP', 'mLSP', 'xSEC'],
                  "T2ttww" : ['xCHI', 'mGL', 'mLSP'],
                  "T3w" : ['xCHI', 'mGL', 'mLSP'],
                  "T3wb" : ['xCHI', 'mGL', 'mLSP'],
	          "T6bbHH" : ['mSQ', 'mLSP', 'mCHI', 'xSEC'],
