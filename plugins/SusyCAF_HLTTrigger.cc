...
produces <int>(prefix+"Photon30L1R8E29"+suffix);
...
produces <int>(prefix+"MinBiasPixelTrk5"+suffix);
...
produces <int>(prefix+"IsoTrack8E29"+suffix);
...
std::auto_ptr< int> hlt_TrackPointing					  (new  int());
   ...
   *hlt_TrackPointing.get() 	         =  -1;			
	...
	iEvent.put(hlt_Photon30_L1R_8E29	   ,prefix+"Photon30L1R8E29"+suffix);
	...
	iEvent.put(hlt_MinBiasPixel_Trk5	   ,prefix+"MinBiasPixelTrk5"+suffix);
	...
	iEvent.put(hlt_IsoTrack_8E29		   ,prefix+"IsoTrack8E29"+suffix);
